...
const DICT: Record<string, { en: string; vi: string }> = {
  ...
  tabWeapons:     { en: 'Weapons', vi: 'Vũ khí' },
  tabAnimals:     { en: 'Animals', vi: 'Động vật' },
  egg_horse:      { en: 'Horse Egg', vi: 'Trứng ngựa' },
  egg_pig:        { en: 'Pig Egg', vi: 'Trứng heo' },
  egg_cow:        { en: 'Cow Egg', vi: 'Trứng bò' },
  egg_chicken:    { en: 'Chicken Egg', vi: 'Trứng gà' },
  egg_sheep:      { en: 'Sheep Egg', vi: 'Trứng cừu' },
  egg_zombie:     { en: 'Zombie Egg', vi: 'Trứng zombie' },
  egg_creeper:    { en: 'Creeper Egg', vi: 'Trứng creeper' },
  // cài đặt
  settings:       { en: '⚙ Settings', vi: '⚙ Cài đặt' },
  settingsTitle:  { en: 'Settings', vi: 'Cài đặt' },
  showHudInfo:    { en: 'HUD info (FPS/XYZ)', vi: 'HUD info (FPS/XYZ)' },
  fancyGraphics:  { en: 'Fancy Graphics', vi: 'Đồ hoạ đẹp' },
  fancyHint:      { en: 'Sharper shadows + higher resolution — needs more GPU', vi: 'Bóng nét hơn + độ phân giải cao — tốn GPU hơn' },
  on:             { en: 'ON', vi: 'BẬT' },
  off:            { en: 'OFF', vi: 'TẮT' },
  // tab cộng đồng (giữ Tab)
  playersTitle:   { en: 'Players online', vi: 'Người chơi online' },
  you:            { en: 'you', vi: 'bạn' },
  actRiding:      { en: '🐴 riding a horse', vi: '🐴 đang cưỡi ngựa' },
  actBoating:     { en: '🛶 sailing a boat', vi: '🛶 đang chèo thuyền' },
  actFlying:      { en: '✈ flying', vi: '✈ đang bay' },
  actExploring:   { en: '⛏ exploring', vi: '⛏ đang khám phá' },
  actIdle:        { en: '💤 idle', vi: '💤 đứng yên' },
  actNether:      { en: '🔥 in the Nether', vi: '🔥 trong Nether' },
