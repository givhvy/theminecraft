// Dữ liệu thế giới: chunk, sinh địa hình, get/set block, lưu chỉnh sửa
...
class WorldMap {
  constructor() {
    this.chunks = new Map();
    this.editsByChunk = {};   // "cx,cz" -> { "lx,ly,lz": id }
  ...
  generateChunk(cx, cz) {
    ...
    // áp dụng chỉnh sửa của người chơi
  ...
  // tìm y của block đặc cao nhất tại cột (x,z)
  topSolidY(wx, wz) {
